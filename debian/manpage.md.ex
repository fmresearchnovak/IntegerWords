% integerwords(SECTION) | User Commands
%
% "December  5 2025"
...
integerwords - program to do something

# SYNOPSIS

**integerwords** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**integerwords** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **integerwords** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**integerwords** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    integerwords. See **foo.conf**(5) for further details.
...
**integerwords** provides some return codes, that can be used in scripts:
...
Ed Novak <enovak@fandm.edu>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Ed Novak
